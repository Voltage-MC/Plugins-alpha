...
class CustomForm extends Form
{
    ...
    {
        $this->addContent(["type" => "dropdown", "text" => $text, "options" => $options, "player" => $default]);
        $this->labelMap[] = $label ?? count($this->labelMap);
    }
    ...
    {
        $this->addContent(["type" => "input", "text" => $text, "placeholder" => $placeholder, "player" => $default]);
        $this->labelMap[] = $label ?? count($this->labelMap);
    }
